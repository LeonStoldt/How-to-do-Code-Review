...
5.	Assign the merge request to a minimum of three developers to avoid stuck issues in case someone is overloaded or sick
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTY5ODQxOTAxMl19
-->