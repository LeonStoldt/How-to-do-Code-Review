...
9.	In order to avoid issues getting stuck in review process / lane, define an explicit day in the week for merging all merge requests 
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEzNDIwODUyNzQsLTE1MDI5MzIzXX0=
-->